...
import domain.tree.TreeEntryMode;
import domain.tree.TreeEntryModeType;
...
public class TreeSerializer implements ObjectContentSerializer<Tree> {
    ...
    public static void serializeEntry(TreeEntry entry,
        ...
        dataOutputStream.write(HEX.parseHex(entry.hash()));
    }
    @Override
    ...
    public static TreeEntry deserializeEntry(DataInputStream dataInputStream)
        ...
        final var hash = HEX.formatHex(hashBytes);
